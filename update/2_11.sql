...
INSERT INTO `co_pianodeiconti3` (`id`, `numero`, `descrizione`, `idpianodeiconti2`, `dir`, `percentuale_deducibile`) VALUES (NULL, '000040', 'Iva su vendite Extra UE', (SELECT `id` FROM `co_pianodeiconti2` WHERE `descrizione`= "Conti transitori"), '', '100.00');
INSERT INTO `co_pianodeiconti3` (`id`, `numero`, `descrizione`, `idpianodeiconti2`, `dir`, `percentuale_deducibile`) VALUES (NULL, '000050', 'Iva su acquisti Extra UE', (SELECT `id` FROM `co_pianodeiconti2` WHERE `descrizione`= "Conti transitori"), '',  '100.00');
INSERT INTO `co_pianodeiconti3` (`id`, `numero`, `descrizione`, `idpianodeiconti2`, `dir`, `percentuale_deducibile`) VALUES (NULL, '000060', 'Iva su vendite Intra UE', (SELECT `id` FROM `co_pianodeiconti2` WHERE `descrizione`= "Conti transitori"), '', '100.00');
INSERT INTO `co_pianodeiconti3` (`id`, `numero`, `descrizione`, `idpianodeiconti2`, `dir`, `percentuale_deducibile`) VALUES (NULL, '000070', 'Iva su acquisti Intra UE', (SELECT `id` FROM `co_pianodeiconti2` WHERE `descrizione`= "Conti transitori"), '', '100.00');
INSERT INTO `co_pianodeiconti3` (`id`, `numero`, `descrizione`, `idpianodeiconti2`, `dir`, `percentuale_deducibile`) VALUES (NULL, '000080', 'Iva su vendite Reverse charge', (SELECT `id` FROM `co_pianodeiconti2` WHERE `descrizione`= "Conti transitori"), '', '100.00');
INSERT INTO `co_pianodeiconti3` (`id`, `numero`, `descrizione`, `idpianodeiconti2`, `dir`, `percentuale_deducibile`) VALUES (NULL, '000090', 'Iva su acquisti Reverse charge', (SELECT `id` FROM `co_pianodeiconti2` WHERE `descrizione`= "Conti transitori"), '', '100.00');

INSERT INTO `zz_settings` (`id`, `nome`, `valore`, `tipo`, `editable`, `sezione`, `order`) VALUES (NULL, 'Conto per Iva su acquisti Extra UE', (SELECT `id` FROM `co_pianodeiconti3` WHERE `descrizione`= "Iva su acquisti Extra UE"), 'query=SELECT `id`, CONCAT_WS(\' - \', `numero`, `descrizione`) AS descrizione FROM `co_pianodeiconti3` ORDER BY `descrizione` ASC', '1', 'Piano dei Conti', NULL);
INSERT INTO `zz_settings` (`id`, `nome`, `valore`, `tipo`, `editable`, `sezione`,`order`) VALUES (NULL, 'Conto per Iva su vendite Extra UE', (SELECT `id` FROM `co_pianodeiconti3` WHERE `descrizione`= "Iva su vendite Extra UE"), 'query=SELECT `id`, CONCAT_WS(\' - \', `numero`, `descrizione`) AS descrizione FROM `co_pianodeiconti3` ORDER BY `descrizione` ASC', '1', 'Piano dei Conti',  NULL);
INSERT INTO `zz_settings` (`id`, `nome`, `valore`, `tipo`, `editable`, `sezione`, `order`) VALUES (NULL, 'Conto per Iva su acquisti Intra UE', (SELECT `id` FROM `co_pianodeiconti3` WHERE `descrizione`= "Iva su acquisti Intra UE"), 'query=SELECT `id`, CONCAT_WS(\' - \', `numero`, `descrizione`) AS descrizione FROM `co_pianodeiconti3` ORDER BY `descrizione` ASC', '1', 'Piano dei Conti', NULL);
INSERT INTO `zz_settings` (`id`, `nome`, `valore`, `tipo`, `editable`, `sezione`, `order`) VALUES (NULL, 'Conto per Iva su vendite Intra UE', (SELECT `id` FROM `co_pianodeiconti3` WHERE `descrizione`= "Iva su vendite Intra UE"), 'query=SELECT `id`, CONCAT_WS(\' - \', `numero`, `descrizione`) AS descrizione FROM `co_pianodeiconti3` ORDER BY `descrizione` ASC', '1', 'Piano dei Conti',  NULL);
INSERT INTO `zz_settings` (`id`, `nome`, `valore`, `tipo`, `editable`, `sezione`, `order`) VALUES (NULL, 'Conto per Iva su acquisti Reverse charge', (SELECT `id` FROM `co_pianodeiconti3` WHERE `descrizione`= "Iva su acquisti Reverse charge"), 'query=SELECT `id`, CONCAT_WS(\' - \', `numero`, `descrizione`) AS descrizione FROM `co_pianodeiconti3` ORDER BY `descrizione` ASC', '1', 'Piano dei Conti',  NULL);
INSERT INTO `zz_settings` (`id`, `nome`, `valore`, `tipo`, `editable`, `sezione`, `order`) VALUES (NULL, 'Conto per Iva su vendite Reverse charge', (SELECT `id` FROM `co_pianodeiconti3` WHERE `descrizione`= "Iva su vendite Reverse charge"), 'query=SELECT `id`, CONCAT_WS(\' - \', `numero`, `descrizione`) AS descrizione FROM `co_pianodeiconti3` ORDER BY `descrizione` ASC', '1', 'Piano dei Conti',  NULL);
...
-- Stato scadenza per i filtri rapidi dei widget Scadenzario
INSERT INTO `zz_views` (`id_module`, `name`, `query`, `order`, `search`, `slow`, `format`, `html_format`, `search_inside`, `order_by`, `visible`, `summable`, `default`) VALUES
((SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario'), 'Stato scadenza', "CASE
    WHEN `co_scadenzario`.`pagato` = `co_scadenzario`.`da_pagare` THEN 'Scadenza pagata'
    WHEN `co_scadenzario`.`data_concordata` IS NOT NULL AND `co_scadenzario`.`data_concordata` != '0000-00-00' AND `co_scadenzario`.`data_concordata` < NOW() THEN 'Data concordata superata'
    WHEN `co_scadenzario`.`data_concordata` IS NOT NULL AND `co_scadenzario`.`data_concordata` != '0000-00-00' THEN 'Data concordata'
    WHEN `co_scadenzario`.`scadenza` < NOW() THEN 'Scaduta'
    WHEN DATEDIFF(`co_scadenzario`.`scadenza`, NOW()) < 10 THEN 'Scadenza entro 10 giorni'
    ELSE 'Scadenza futura'
END", 22, 1, 0, 0, 0, "`Stato scadenza`", "`Stato scadenza`", 1, 0, 1);
INSERT INTO `zz_views_lang` (`id_lang`, `id_record`, `title`) VALUES
(1, (SELECT `id` FROM `zz_views` WHERE `id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario') AND `name` = 'Stato scadenza'), 'Stato scadenza'),
(2, (SELECT `id` FROM `zz_views` WHERE `id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario') AND `name` = 'Stato scadenza'), 'Due date status');
INSERT IGNORE INTO `zz_group_view` (`id_gruppo`, `id_vista`)
SELECT DISTINCT `zz_groups`.`id`, `zz_views`.`id`
FROM `zz_groups`
INNER JOIN `zz_views` ON `zz_views`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario') AND `zz_views`.`name` = 'Stato scadenza'
LEFT JOIN `zz_permissions` ON `zz_permissions`.`idgruppo` = `zz_groups`.`id` AND `zz_permissions`.`idmodule` = `zz_views`.`id_module`
WHERE `zz_groups`.`nome` = 'Amministratori' OR `zz_permissions`.`permessi` IN ('r', 'rw');
...
FROM
    ...
    LEFT JOIN (SELECT SUM(`qta` - `qta_evasa`) AS qta_impegnata, `id_articolo` FROM `or_righe_ordini` INNER JOIN `or_ordini` ON `or_righe_ordini`.`id_ordine` = `or_ordini`.`id` WHERE `id_stato` IN(SELECT `id` FROM `or_stati_ordine` WHERE `is_bloccato` = 0) GROUP BY `id_articolo`) ordini ON `ordini`.`id_articolo` = `mg_articoli`.`id`
...
HAVING 
    2=2 
ORDER BY 
    nome_sede ASC" WHERE `name` = "Automezzi";
...
ALTER TABLE `in_tariffe` CHANGE `idtecnico` `id_tecnico` INT NOT NULL;
ALTER TABLE `my_impianti` CHANGE `idtecnico` `id_tecnico` INT NOT NULL;
...
ALTER TABLE `or_ordini` CHANGE `idreferente` `id_referente` INT NULL DEFAULT NULL;
...
ALTER TABLE `my_impianti_contratti` CHANGE `idcontratto` `id_contratto` INT NOT NULL;
...
ALTER TABLE `in_righe_tipiinterventi` CHANGE `id_tipointervento` `id_tipo_intervento` VARCHAR(25) NOT NULL;
ALTER TABLE `in_tariffe` CHANGE `idtipointervento` `id_tipo_intervento` INT NOT NULL;
ALTER TABLE `in_tariffe_sedi` CHANGE `idtipointervento` `id_tipo_intervento` INT NOT NULL;
ALTER TABLE `in_tipiintervento_groups` CHANGE `idtipointervento` `id_tipo_intervento` INT NOT NULL;
ALTER TABLE `in_tipiintervento_tipologie` CHANGE `idtipointervento` `id_tipo_intervento` INT NOT NULL;

ALTER TABLE `co_contratti_tipiintervento` CHANGE `costo_dirittochiamata` `costo_diritto_chiamata` DECIMAL(15,6) NOT NULL;
ALTER TABLE `in_tariffe` CHANGE `costo_dirittochiamata` `costo_diritto_chiamata` DECIMAL(15,6) NOT NULL;
ALTER TABLE `in_tariffe_sedi` CHANGE `costo_dirittochiamata` `costo_diritto_chiamata` DECIMAL(12,4) NOT NULL;
...
ALTER TABLE `mg_movimenti` CHANGE `iddocumento` `id_documento` INT NOT NULL;
...
ALTER TABLE `mg_articoli` CHANGE `idconto_vendita` `id_conto_vendita` INT NULL DEFAULT NULL;

ALTER TABLE `co_pagamenti` CHANGE `idconto_acquisti` `id_conto_acquisti` INT NULL DEFAULT NULL;
ALTER TABLE `mg_articoli` CHANGE `idconto_acquisto` `id_conto_acquisto` INT NULL DEFAULT NULL;
...
ALTER TABLE `in_righe_interventi` CHANGE `idintervento` `id_intervento` INT NULL DEFAULT NULL;
ALTER TABLE `mg_movimenti` CHANGE `idintervento` `id_intervento` INT NULL DEFAULT NULL;
ALTER TABLE `my_impianti_interventi` CHANGE `idintervento` `id_intervento` INT NULL DEFAULT NULL;
ALTER TABLE `my_impianto_componenti` CHANGE `idintervento` `id_intervento` INT NULL DEFAULT NULL;
...
ALTER TABLE `in_righe_interventi` CHANGE `idimpianto` `id_impianto` INT NULL DEFAULT NULL;
ALTER TABLE `my_impianti_contratti` CHANGE `idimpianto` `id_impianto` INT NULL DEFAULT NULL;
ALTER TABLE `my_impianti_interventi` CHANGE `idimpianto` `id_impianto` INT NULL DEFAULT NULL;
ALTER TABLE `my_impianto_componenti` CHANGE `idimpianto` `id_impianto` INT NULL DEFAULT NULL;
...
ALTER TABLE `mg_movimenti` CHANGE `idddt` `id_ddt` INT NOT NULL;
...
ALTER TABLE `in_interventi_tecnici` CHANGE `scontokm_unitario` `sconto_km_unitario` DECIMAL(17,8) NOT NULL;
ALTER TABLE `in_interventi_tecnici` CHANGE `tipo_scontokm` `tipo_sconto_km` ENUM('UNT','PRC') NOT NULL DEFAULT 'UNT';

ALTER TABLE `mg_movimenti` CHANGE `idutente` `id_utente` INT NULL DEFAULT NULL;
...
UPDATE `zz_widgets` SET `query` = 'SELECT COUNT(id) AS dato FROM in_interventi WHERE id NOT IN (SELECT id_intervento FROM in_interventi_tecnici) AND id_stato IN (SELECT id FROM in_stati_intervento WHERE is_bloccato = 0)' WHERE `zz_widgets`.`name` = "Attività da pianificare";

UPDATE `zz_widgets` SET `query` = 'SELECT COUNT(id) AS dato FROM in_interventi WHERE in_interventi.id_stato = (SELECT in_stati_intervento.id FROM in_stati_intervento WHERE in_stati_intervento.codice=\'TODO\') ORDER BY in_interventi.data_richiesta ASC' WHERE `zz_widgets`.`name` = "Attività nello stato da programmare";

UPDATE `zz_widgets` SET `query` = 'SELECT COUNT(id) AS dato FROM in_interventi WHERE in_interventi.id_stato = (SELECT in_stati_intervento.id FROM in_stati_intervento WHERE in_stati_intervento.codice=\'WIP\') ORDER BY in_interventi.data_richiesta ASC' WHERE `zz_widgets`.`name` = "Attività confermate";
...
UPDATE `zz_plugins` SET `options` = '{ "main_query": [	{	"type": "table", "fields": "Nominativo, Mansione, Telefono, Indirizzo email, Sede",	"query": "SELECT an_referenti.id, an_referenti.nome AS Nominativo, an_mansioni.nome AS Mansione, an_referenti.telefono AS Telefono, an_referenti.email AS \'Indirizzo email\', IF(id_sede = 0, \'Sede legale\', an_sedi.nome_sede) AS Sede FROM an_referenti LEFT OUTER JOIN an_sedi ON id_sede = an_sedi.id LEFT OUTER JOIN an_mansioni ON id_mansione = an_mansioni.id WHERE 1=1 AND an_referenti.id_anagrafica=|id_parent| HAVING 2=2 ORDER BY an_referenti.id DESC"}]}' WHERE `name` = "Referenti";
...
UPDATE `zz_settings` SET `tipo` = "query=SELECT id, CONCAT_WS(' - ', numero, descrizione) AS descrizione FROM co_piano_dei_conti3 WHERE dir='entrata'" WHERE `nome` = "Conto predefinito fatture di vendita";
UPDATE `zz_settings` SET `tipo` = "query=SELECT id, CONCAT_WS(' - ', numero, descrizione) AS descrizione FROM co_piano_dei_conti3 WHERE dir='uscita'" WHERE `nome` = "Conto predefinito fatture di acquisto";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `in_stati_intervento`.`id`, `name` AS text FROM `in_stati_intervento` LEFT JOIN `in_stati_intervento_lang` ON (`in_stati_intervento_lang`.`id_record` = `in_stati_intervento`.`id` AND `in_stati_intervento_lang`.`id_lang` = (SELECT `valore` FROM `zz_settings` WHERE `nome` = \"Lingua\")) WHERE is_bloccato = 1" WHERE `nome` = "Stato dell'attività alla chiusura";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `in_stati_intervento`.`id`, `name` AS text FROM `in_stati_intervento` LEFT JOIN `in_stati_intervento_lang` ON (`in_stati_intervento_lang`.`id_record` = `in_stati_intervento`.`id` AND `in_stati_intervento_lang`.`id_lang` = (SELECT `valore` FROM `zz_settings` WHERE `nome` = \"Lingua\")) WHERE is_bloccato = 1" WHERE `nome` = "Stato dell'attività dopo la firma";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `in_stati_intervento`.`id`, `name` AS text FROM `in_stati_intervento` LEFT JOIN `in_stati_intervento_lang` ON (`in_stati_intervento_lang`.`id_record` = `in_stati_intervento`.`id` AND `in_stati_intervento_lang`.`id_lang` = (SELECT `valore` FROM `zz_settings` WHERE `nome` = \"Lingua\"))" WHERE `nome` = "Stato predefinito dell'attività da Dashboard";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `in_stati_intervento`.`id`, `name` AS text FROM `in_stati_intervento` LEFT JOIN `in_stati_intervento_lang` ON (`in_stati_intervento_lang`.`id_record` = `in_stati_intervento`.`id` AND `in_stati_intervento_lang`.`id_lang` = (SELECT `valore` FROM `zz_settings` WHERE `nome` = \"Lingua\"))" WHERE `nome` = "Stato predefinito dell'attività";
UPDATE `zz_settings` SET `tipo` = "query=SELECT id, CONCAT_WS(' - ', numero, descrizione) AS descrizione FROM co_piano_dei_conti3" WHERE `nome` = "Conto anticipo clienti";
UPDATE `zz_settings` SET `tipo` = "query=SELECT id, CONCAT_WS(' - ', numero, descrizione) AS descrizione FROM co_piano_dei_conti3" WHERE `nome` = "Conto anticipo fornitori";
UPDATE `zz_settings` SET `tipo` = "query=SELECT id, valore as descrizione FROM mg_unita_misura" WHERE `nome` = "Unità di misura predefinita";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Riepilogativo fornitori";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Riepilogativo clienti";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Iva indetraibile";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Iva su vendite";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Iva su acquisti";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Erario c/ritenute d'acconto";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Erario c/INPS";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Erario c/enasarco";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Apertura conti patrimoniali";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Chiusura conti patrimoniali";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per autofattura";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Iva transitoria";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per erario Iva";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Iva su acquisti Extra UE";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Iva su vendite Extra UE";
UPDATE `zz_settings` SET `tipo` = "query=SELECT `id`, CONCAT_WS(' - ', `numero`, `descrizione`) AS descrizione FROM `co_piano_dei_conti3` ORDER BY `descrizione` ASC" WHERE `nome` = "Conto per Iva su acquisti Intra UE";
...
UPDATE `zz_group_module` SET `clause` = 'in_interventi.id IN (SELECT id_intervento FROM in_interventi_tecnici WHERE id_intervento=in_interventi.id AND id_tecnico=|id_anagrafica| UNION SELECT id_intervento FROM in_interventi_tecnici_assegnati WHERE id_intervento=in_interventi.id AND id_tecnico=|id_anagrafica|)' WHERE `zz_group_module`.`name` = 'Mostra al tecnico solo le sue attività programmate e assegnate' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Interventi');
UPDATE `zz_group_module` SET `clause` = 'an_anagrafiche.id IN (SELECT in_interventi.id_anagrafica FROM in_interventi_tecnici INNER JOIN in_interventi ON in_interventi_tecnici.id_intervento=in_interventi.id WHERE in_interventi.id_anagrafica=an_anagrafiche.id AND in_interventi_tecnici.id_tecnico=|id_anagrafica|)' WHERE `zz_group_module`.`name` = 'Mostra ai tecnici solo le anagrafiche in cui sono coinvolti con delle attività' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Anagrafiche');
UPDATE `zz_group_module` SET `clause` = 'an_anagrafiche.id_agente=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra agli agenti solo le anagrafiche di cui sono agenti' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Anagrafiche');
UPDATE `zz_group_module` SET `clause` = 'an_anagrafiche.id=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra ai clienti solo la propria anagrafica' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Anagrafiche');
UPDATE `zz_group_module` SET `clause` = 'in_interventi.id_anagrafica=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra al cliente solo le attività in cui è impostato come ''Cliente''' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Interventi');
UPDATE `zz_group_module` SET `clause` = 'co_documenti.id_anagrafica=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra ai clienti solo le proprie fatture' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Fatture di vendita');
UPDATE `zz_group_module` SET `clause` = 'id_agente=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra agli agenti solo la prima nota delle anagrafiche di cui sono agenti' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Prima nota');
UPDATE `zz_group_module` SET `clause` = 'my_impianti.id_anagrafica=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra ai clienti solo i propri impianti' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Impianti');
UPDATE `zz_group_module` SET `clause` = 'dt_ddt.id_anagrafica=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra ddt di vendita ai clienti coinvolti' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Ddt in uscita');
UPDATE `zz_group_module` SET `clause` = 'or_ordini.id_anagrafica=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra ordini cliente ai clienti coinvolti' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Ordini cliente');
UPDATE `zz_group_module` SET `clause` = 'co_contratti.id_anagrafica=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra i contratti ai clienti coinvolti' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Contratti');
UPDATE `zz_group_module` SET `clause` = 'my_impianti.id_tecnico=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra impianti ai tecnici assegnati' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Impianti');
UPDATE `zz_group_module` SET `clause` = 'co_preventivi.id_anagrafica=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra agli agenti solo le anagrafiche di cui sono agenti' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Preventivi');
UPDATE `zz_group_module` SET `clause` = 'an_anagrafiche.id_agente=|id_anagrafica|' WHERE `zz_group_module`.`name` = 'Mostra agli agenti solo i preventivi dei clienti dei quali si è agenti' AND `zz_group_module`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Preventivi');
...
-- Widget riepilogativi Scadenzario in sostituzione della legenda
DELETE FROM `zz_widgets` WHERE `id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario') AND `name` IN ('Scadenza pagata', 'Data concordata superata', 'Data concordata', 'Scaduta', 'Scadenza entro 10 giorni', 'Scadenza futura');
...
('Scadenza pagata', 'stats', (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario'), 'controller_top', 'col-md-2', 'SELECT CONCAT(COUNT(`co_scadenzario`.`id`), " / ", REPLACE(REPLACE(REPLACE(FORMAT(IFNULL(SUM(ABS(`co_scadenzario`.`da_pagare`)), 0), 2), ",", "#"), ".", ","), "#", "."), " €") AS dato FROM `co_scadenzario` LEFT JOIN `co_documenti` ON `co_scadenzario`.`id_documento` = `co_documenti`.`id` LEFT JOIN `co_banche` ON `co_banche`.`id` = `co_documenti`.`id_banca_azienda` LEFT JOIN `an_anagrafiche` ON `co_scadenzario`.`id_anagrafica` = `an_anagrafiche`.`id` LEFT JOIN `co_pagamenti` ON `co_documenti`.`id_pagamento` = `co_pagamenti`.`id` LEFT JOIN `co_tipi_documento` ON `co_documenti`.`id_tipo_documento` = `co_tipi_documento`.`id` LEFT JOIN `co_stati_documento` ON `co_documenti`.`id_stato` = `co_stati_documento`.`id` WHERE 1=1 AND (`co_stati_documento`.`id` IS NULL OR `co_stati_documento`.`name` IN ("Emessa", "Parzialmente pagato", "Pagato")) AND `co_scadenzario`.`pagato` = `co_scadenzario`.`da_pagare`', '#CCFFCC', 'fa fa-check', '', 'scadenzarioFiltroWidget(''Scadenza pagata'');', 'javascript', '', 1, 1, 'Numero scadenze / valore economico'),
('Data concordata superata', 'stats', (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario'), 'controller_top', 'col-md-2', 'SELECT CONCAT(COUNT(`co_scadenzario`.`id`), " / ", REPLACE(REPLACE(REPLACE(FORMAT(IFNULL(SUM(ABS(`co_scadenzario`.`da_pagare`)), 0), 2), ",", "#"), ".", ","), "#", "."), " €") AS dato FROM `co_scadenzario` LEFT JOIN `co_documenti` ON `co_scadenzario`.`id_documento` = `co_documenti`.`id` LEFT JOIN `co_banche` ON `co_banche`.`id` = `co_documenti`.`id_banca_azienda` LEFT JOIN `an_anagrafiche` ON `co_scadenzario`.`id_anagrafica` = `an_anagrafiche`.`id` LEFT JOIN `co_pagamenti` ON `co_documenti`.`id_pagamento` = `co_pagamenti`.`id` LEFT JOIN `co_tipi_documento` ON `co_documenti`.`id_tipo_documento` = `co_tipi_documento`.`id` LEFT JOIN `co_stati_documento` ON `co_documenti`.`id_stato` = `co_stati_documento`.`id` WHERE 1=1 AND (`co_stati_documento`.`id` IS NULL OR `co_stati_documento`.`name` IN ("Emessa", "Parzialmente pagato", "Pagato")) AND `co_scadenzario`.`pagato` != `co_scadenzario`.`da_pagare` AND `co_scadenzario`.`data_concordata` IS NOT NULL AND `co_scadenzario`.`data_concordata` != "0000-00-00" AND `co_scadenzario`.`data_concordata` < NOW()', '#ec5353', 'fa fa-calendar-times-o', '', 'scadenzarioFiltroWidget(''Data concordata superata'');', 'javascript', '', 1, 2, 'Numero scadenze / valore economico'),
('Data concordata', 'stats', (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario'), 'controller_top', 'col-md-2', 'SELECT CONCAT(COUNT(`co_scadenzario`.`id`), " / ", REPLACE(REPLACE(REPLACE(FORMAT(IFNULL(SUM(ABS(`co_scadenzario`.`da_pagare`)), 0), 2), ",", "#"), ".", ","), "#", "."), " €") AS dato FROM `co_scadenzario` LEFT JOIN `co_documenti` ON `co_scadenzario`.`id_documento` = `co_documenti`.`id` LEFT JOIN `co_banche` ON `co_banche`.`id` = `co_documenti`.`id_banca_azienda` LEFT JOIN `an_anagrafiche` ON `co_scadenzario`.`id_anagrafica` = `an_anagrafiche`.`id` LEFT JOIN `co_pagamenti` ON `co_documenti`.`id_pagamento` = `co_pagamenti`.`id` LEFT JOIN `co_tipi_documento` ON `co_documenti`.`id_tipo_documento` = `co_tipi_documento`.`id` LEFT JOIN `co_stati_documento` ON `co_documenti`.`id_stato` = `co_stati_documento`.`id` WHERE 1=1 AND (`co_stati_documento`.`id` IS NULL OR `co_stati_documento`.`name` IN ("Emessa", "Parzialmente pagato", "Pagato")) AND `co_scadenzario`.`pagato` != `co_scadenzario`.`da_pagare` AND `co_scadenzario`.`data_concordata` IS NOT NULL AND `co_scadenzario`.`data_concordata` != "0000-00-00" AND `co_scadenzario`.`data_concordata` >= NOW()', '#b3d2e3', 'fa fa-calendar-check-o', '', 'scadenzarioFiltroWidget(''Data concordata'');', 'javascript', '', 1, 3, 'Numero scadenze / valore economico'),
('Scaduta', 'stats', (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario'), 'controller_top', 'col-md-2', 'SELECT CONCAT(COUNT(`co_scadenzario`.`id`), " / ", REPLACE(REPLACE(REPLACE(FORMAT(IFNULL(SUM(ABS(`co_scadenzario`.`da_pagare`)), 0), 2), ",", "#"), ".", ","), "#", "."), " €") AS dato FROM `co_scadenzario` LEFT JOIN `co_documenti` ON `co_scadenzario`.`id_documento` = `co_documenti`.`id` LEFT JOIN `co_banche` ON `co_banche`.`id` = `co_documenti`.`id_banca_azienda` LEFT JOIN `an_anagrafiche` ON `co_scadenzario`.`id_anagrafica` = `an_anagrafiche`.`id` LEFT JOIN `co_pagamenti` ON `co_documenti`.`id_pagamento` = `co_pagamenti`.`id` LEFT JOIN `co_tipi_documento` ON `co_documenti`.`id_tipo_documento` = `co_tipi_documento`.`id` LEFT JOIN `co_stati_documento` ON `co_documenti`.`id_stato` = `co_stati_documento`.`id` WHERE 1=1 AND (`co_stati_documento`.`id` IS NULL OR `co_stati_documento`.`name` IN ("Emessa", "Parzialmente pagato", "Pagato")) AND `co_scadenzario`.`pagato` != `co_scadenzario`.`da_pagare` AND (`co_scadenzario`.`data_concordata` IS NULL OR `co_scadenzario`.`data_concordata` = "0000-00-00") AND `co_scadenzario`.`scadenza` < NOW()', '#f08080', 'fa fa-exclamation-triangle', '', 'scadenzarioFiltroWidget(''Scaduta'');', 'javascript', '', 1, 4, 'Numero scadenze / valore economico'),
('Scadenza entro 10 giorni', 'stats', (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario'), 'controller_top', 'col-md-2', 'SELECT CONCAT(COUNT(`co_scadenzario`.`id`), " / ", REPLACE(REPLACE(REPLACE(FORMAT(IFNULL(SUM(ABS(`co_scadenzario`.`da_pagare`)), 0), 2), ",", "#"), ".", ","), "#", "."), " €") AS dato FROM `co_scadenzario` LEFT JOIN `co_documenti` ON `co_scadenzario`.`id_documento` = `co_documenti`.`id` LEFT JOIN `co_banche` ON `co_banche`.`id` = `co_documenti`.`id_banca_azienda` LEFT JOIN `an_anagrafiche` ON `co_scadenzario`.`id_anagrafica` = `an_anagrafiche`.`id` LEFT JOIN `co_pagamenti` ON `co_documenti`.`id_pagamento` = `co_pagamenti`.`id` LEFT JOIN `co_tipi_documento` ON `co_documenti`.`id_tipo_documento` = `co_tipi_documento`.`id` LEFT JOIN `co_stati_documento` ON `co_documenti`.`id_stato` = `co_stati_documento`.`id` WHERE 1=1 AND (`co_stati_documento`.`id` IS NULL OR `co_stati_documento`.`name` IN ("Emessa", "Parzialmente pagato", "Pagato")) AND `co_scadenzario`.`pagato` != `co_scadenzario`.`da_pagare` AND (`co_scadenzario`.`data_concordata` IS NULL OR `co_scadenzario`.`data_concordata` = "0000-00-00") AND `co_scadenzario`.`scadenza` >= NOW() AND DATEDIFF(`co_scadenzario`.`scadenza`, NOW()) < 10', '#f9f9c6', 'fa fa-clock-o', '', 'scadenzarioFiltroWidget(''Scadenza entro 10 giorni'');', 'javascript', '', 1, 5, 'Numero scadenze / valore economico'),
('Scadenza futura', 'stats', (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario'), 'controller_top', 'col-md-2', 'SELECT CONCAT(COUNT(`co_scadenzario`.`id`), " / ", REPLACE(REPLACE(REPLACE(FORMAT(IFNULL(SUM(ABS(`co_scadenzario`.`da_pagare`)), 0), 2), ",", "#"), ".", ","), "#", "."), " €") AS dato FROM `co_scadenzario` LEFT JOIN `co_documenti` ON `co_scadenzario`.`id_documento` = `co_documenti`.`id` LEFT JOIN `co_banche` ON `co_banche`.`id` = `co_documenti`.`id_banca_azienda` LEFT JOIN `an_anagrafiche` ON `co_scadenzario`.`id_anagrafica` = `an_anagrafiche`.`id` LEFT JOIN `co_pagamenti` ON `co_documenti`.`id_pagamento` = `co_pagamenti`.`id` LEFT JOIN `co_tipi_documento` ON `co_documenti`.`id_tipo_documento` = `co_tipi_documento`.`id` LEFT JOIN `co_stati_documento` ON `co_documenti`.`id_stato` = `co_stati_documento`.`id` WHERE 1=1 AND (`co_stati_documento`.`id` IS NULL OR `co_stati_documento`.`name` IN ("Emessa", "Parzialmente pagato", "Pagato")) AND `co_scadenzario`.`pagato` != `co_scadenzario`.`da_pagare` AND (`co_scadenzario`.`data_concordata` IS NULL OR `co_scadenzario`.`data_concordata` = "0000-00-00") AND `co_scadenzario`.`scadenza` >= NOW() AND DATEDIFF(`co_scadenzario`.`scadenza`, NOW()) >= 10', '#ffffff', 'fa fa-calendar-o', '', 'scadenzarioFiltroWidget(''Scadenza futura'');', 'javascript', '', 1, 6, 'Numero scadenze / valore economico');

INSERT INTO `zz_widgets_lang` (`id_lang`, `id_record`, `name`, `text`)
SELECT `zz_langs`.`id`, `zz_widgets`.`id`, `zz_widgets`.`name`, `zz_widgets`.`name`
FROM `zz_widgets`
CROSS JOIN `zz_langs`
WHERE `zz_widgets`.`id_module` = (SELECT `id` FROM `zz_modules` WHERE `name` = 'Scadenzario')
    AND `zz_widgets`.`name` IN ('Scadenza pagata', 'Data concordata superata', 'Data concordata', 'Scaduta', 'Scadenza entro 10 giorni', 'Scadenza futura');
