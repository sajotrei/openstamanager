        ...
        <div class="card card-outline card-secondary">
            ...
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right text-nowrap">
                                        <form method="post" class="d-inline">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-info" title="<?php echo tr('Test connessione'); ?>">
                                        ...
                                        <form method="post" class="d-inline">
                                            ...
                                            <input type="hidden" name="id" value="<?php echo (int) $destination->id; ?>">
                                            <button type="submit" class="btn btn-sm btn-secondary" title="<?php echo $destination->enabled ? tr('Disattiva') : tr('Attiva'); ?>">
                                                <i class="fa <?php echo $destination->enabled ? 'fa-pause' : 'fa-play'; ?>"></i>
                                            </button>
                                        </form>
                                        <button type="button" class="btn btn-sm btn-warning" data-toggle="collapse" data-target="#backup-destination-<?php echo (int) $destination->id; ?>" title="<?php echo tr('Modifica'); ?>">
                                        ...
                                        <form method="post" class="d-inline" onsubmit="return confirm('<?php echo $esc(tr('Eliminare questa destinazione di backup?')); ?>');">
                                            ...
                                            <input type="hidden" name="id" value="<?php echo (int) $destination->id; ?>">
                                            <button type="submit" class="btn btn-sm btn-danger" title="<?php echo tr('Elimina'); ?>">
                                    ...
                                    <td colspan="6">
                                        <form method="post" class="form-row align-items-end">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="id_adapter" class="form-control" required>
                                                    <?php foreach ($adapters as $item) { ?>
                                                        <option value="<?php echo (int) $item->id; ?>" <?php echo (int) $item->id === (int) $destination->id_adapter ? 'selected' : ''; ?>>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" name="path" class="form-control" value="<?php echo $esc($destination->path); ?>" placeholder="backups">
                                            </div>
                ...
                <div class="card bg-light mb-0">
                    <div class="card-header">
                        <strong><?php echo tr('Aggiungi destinazione'); ?></strong>
                    </div>
                    <div class="card-body">
                        <?php if ($adapters->isEmpty()) { ?>
                            <div class="alert alert-warning mb-0">
                                <?php echo tr('Non sono disponibili adattatori secondari. Configura prima un adattatore di archiviazione da Strumenti.'); ?>
                            </div>
                        <?php } else { ?>
                            <form method="post" class="form-row align-items-end">
                                ...
                                <div class="form-group col-md-3">
                                    <label><?php echo tr('Percorso relativo'); ?></label>
                                    <input type="text" name="path" class="form-control" value="backups" placeholder="backups">
                                </div>
                                <div class="form-group col-md-2">
                                    <label><?php echo tr('Retention'); ?></label>
