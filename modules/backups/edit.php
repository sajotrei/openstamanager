                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 text-right">
                                                <div class="btn-group">
                                                    <a class="btn btn-sm btn-primary" href="'.base_path_osm().'/modules/backups/actions.php?op=getfile&number='.$id.'" target="_blank">
