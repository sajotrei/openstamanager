...
namespace Modules\Partitario\Tests;
...
class EsercizioTest extends TestCase
{
    ...
    public function testAperturaCon184ContiEChiusuraCon208Conti(): void
    {
        ...
        $this->assertArrayHasKey('id_conto', $opening['entries'][0]);
    ...
    {
        $entries = [
            ['id_conto' => 1, 'totale' => 100.0],
            ['id_conto' => 2, 'totale' => -40.0],
            ['id_conto' => 99, 'totale' => -60.0],
        ];
